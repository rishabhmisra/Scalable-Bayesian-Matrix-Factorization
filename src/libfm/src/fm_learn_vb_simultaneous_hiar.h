...
#ifndef FM_LEARN_VB_SIMULTANEOUS_HIAR_H_
#define FM_LEARN_VB_SIMULTANEOUS_HIAR_H_

#include "fm_learn_vb_hiar.h"


class fm_learn_vb_simultaneous_hiar : public fm_learn_vb_hiar {
	protected:
		...
		virtual void _learn(DataSubset& train, DataSubset& test) {
			...
			for (uint i = num_complete_iter; i < num_iter; i++) {
				...
				nan_alpha_0_dash=0; nan_beta_0_dash=0; nan_mu_0_dash=0; nan_sigma_0_dash=0; nan_mu_w_bar=0; nan_sigma_w_bar=0; nan_alpha_w_dash=0;
		nan_beta_w_dash=0; nan_mu_v_bar=0; nan_sigma_w_bar=0; nan_alpha_v_dash=0; nan_beta_v_dash=0; nan_mu_w_dash=0;
		nan_sigma_w_dash=0; nan_mu_v_dash=0; nan_sigma_v_dash=0;


				update_all(train);


				if ((nan_alpha_0_dash > 0) || (inf_alpha_0_dash > 0)) {
					std::cout << "#nans in alpha:\t" << nan_alpha_0_dash << "\t#inf_in_alpha:\t" << inf_alpha_0_dash << std::endl;
				}
				if ((nan_beta_0_dash > 0) || (inf_beta_0_dash > 0)) {
					std::cout << "#nans in alpha:\t" << nan_beta_0_dash << "\t#inf_in_alpha:\t" << inf_beta_0_dash << std::endl;
				}
				...
				if ((nan_mu_w_bar > 0) || (inf_mu_w_bar > 0)) {
					std::cout << "#nans in alpha:\t" << nan_mu_w_bar << "\t#inf_in_alpha:\t" << inf_mu_w_bar << std::endl;
				}
				if ((nan_sigma_w_bar > 0) || (inf_sigma_w_bar > 0)) {
					std::cout << "#nans in alpha:\t" << nan_sigma_w_bar << "\t#inf_in_alpha:\t" << inf_sigma_w_bar << std::endl;
				}
				if ((nan_alpha_w_dash > 0) || (inf_alpha_w_dash > 0)) {
					std::cout << "#nans in alpha:\t" << nan_alpha_w_dash << "\t#inf_in_alpha:\t" << inf_alpha_w_dash << std::endl;
				}
				if ((nan_beta_w_dash > 0) || (inf_beta_w_dash > 0)) {
					std::cout << "#nans in alpha:\t" << nan_beta_w_dash << "\t#inf_in_alpha:\t" << inf_beta_w_dash << std::endl;
				}
				if ((nan_mu_v_bar > 0) || (inf_mu_v_bar > 0)) {
					std::cout << "#nans in alpha:\t" << nan_mu_v_bar << "\t#inf_in_alpha:\t" << inf_mu_v_bar << std::endl;
				}
				if ((nan_sigma_v_bar > 0) || (inf_sigma_v_bar > 0)) {
					std::cout << "#nans in alpha:\t" << nan_sigma_v_bar << "\t#inf_in_alpha:\t" << inf_sigma_v_bar << std::endl;
				}
				if ((nan_alpha_v_dash > 0) || (inf_alpha_v_dash > 0)) {
					std::cout << "#nans in alpha:\t" << nan_alpha_v_dash << "\t#inf_in_alpha:\t" << inf_alpha_v_dash << std::endl;
				}
				if ((nan_beta_v_dash > 0) || (inf_beta_v_dash > 0)) {
					std::cout << "#nans in alpha:\t" << nan_beta_v_dash << "\t#inf_in_alpha:\t" << inf_beta_v_dash << std::endl;
				}
